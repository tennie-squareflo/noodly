                                    ...
                                    <tbody>
                                      <tr>
                                        <td valign="top" align="center">
                                          <a href="//<?php echo $publisher['domain']; ?>" style="text-decoration: none;"><img src="<?php echo '//'.$publisher['domain'].ASSETS_URL.'media/logos/'.$publisher['logo']; ?>" width="130" height="" alt="" style="max-width: 100%; height: auto; border: 0; line-height: 100%; outline: 0; -ms-interpolation-mode: bicubic; color: <?php echo $env['email_foreground_color'];?>;"></a>
                                        </td>
                                      </tr>
                                      <tr>
