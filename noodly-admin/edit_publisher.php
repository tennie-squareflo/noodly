...
<div class="k-content	k-grid__item k-grid__item--fluid k-grid k-grid--hor">
		...
		<div class="k-content	k-grid__item k-grid__item--fluid k-grid k-grid--hor" id="k_content">
			...
			<div class="k-content__head	k-grid__item">
				...
				<div class="k-content__head-toolbar">
					<div class="k-content__head-toolbar-wrapper">
						...
						<a href="client-profile.html" class="btn btn-success">
			...
			<div class="k-content__body	k-grid__item k-grid__item--fluid" id="k_content_body">
                ...
                ?>
								<form class="k-form" id="k_form"  method="post" enctype="multipart/form-data">
									<div class="row">
											...
											<div class="k-section k-section--first">
												<div class="k-section__body">
													...
													<div class="form-group row">
														...
														<div class="col-9">
															<input class="form-control" type="text" value="<?php echo count($publisher) ? $publisher['name'] : ''; ?>">
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-9">
															<div class="input-group">
																...
																<input type="text" class="form-control" value="<?php echo count($publisher) ? $publisher['phonenumber'] : ''; ?>" placeholder="Phone" aria-describedby="basic-addon1">
															</div>
														</div>
													</div>
													<div class="form-group row">
														...
														<div class="col-9">
															<div class="input-group">
																...
																<input type="text" class="form-control" value="<?php echo count($publisher) ? $publisher['email'] : ''; ?>" placeholder="Email" aria-describedby="basic-addon1">
															</div>
														</div>
													</div>
											...
											<div class="k-section">
												<div class="k-section__body">
													...
													<div class="form-group row">
														...
														<div class="col-9">
                              <select class="form-control" value="<?php echo count($publisher) ? $publisher['country'] : ''; ?>">
                                ...
                                ?>
													...
													<div class="form-group row">
														...
														<div class="col-9">
															<input class="form-control" type="text" value="<?php echo count($publisher) ? $publisher['state'] : ''; ?>">
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-9">
															<input class="form-control" type="text" value="<?php echo count($publisher) ? $publisher['address1'] : ''; ?>">
														</div>
													</div>
													<div class="form-group row">
														<label class="col-3 col-form-label">Address Line 2</label>
														<div class="col-9">
															<input class="form-control" type="text" value="<?php echo count($publisher) ? $publisher['address2'] : ''; ?>">
														</div>
													</div>
													<div class="form-group row">
														<label class="col-3 col-form-label">City</label>
														<div class="col-9">
															<input class="form-control" type="text" value="<?php echo count($publisher) ? $publisher['city'] : ''; ?>">
														</div>
													</div>
													...
													<div class="form-group row">
														...
														<div class="col-9">
															<input class="form-control" type="text" value="<?php echo count($publisher) ? $publisher['zipcode'] : ''; ?>">
														</div>
													</div>
