...
class Index_Controller extends Auth_Controller {
  ...
  function index() {
    ...
    $this->view_data['categories'] = $this->category_model->get_categories($this->publisher['pid'], 0);
    $this->view_data['trendings'] = $this->category_model->get_channels($this->publisher['pid'], 'most_popular', 5);
    $this->view_data['stories'] = $this->story_model->get_published_recent_stories($this->publisher['pid'], 0);
  ...
  function aboutus() {
    ...
    $this->view_data['stories_count'] = $this->story_model->get_stories_count($this->publisher['pid'], 0);
    $this->view_data['contributors'] = $this->publisher_model->get_active_contributors($this->publisher['pid']);
    $this->view_data['trendings'] = $this->category_model->get_channels($this->publisher['pid'], 'most_popular', 5);
  ...
  function popular() {
    ...
    $this->view_data['categories'] = $this->category_model->get_categories($this->publisher['pid'], 0);
    $this->view_data['trendings'] = $this->category_model->get_channels($this->publisher['pid'], 'most_popular', 5);
    $this->view_data['stories'] = $this->story_model->get_published_popular_stories($this->publisher['pid'], 0);
    $this->load_view('common/stories', $this->view_data);
  }
  ...
  function channels() {
    ...
    $this->view_data['channels'] = $this->category_model->get_channels($this->publisher['pid'], 'az');
    $this->view_data['trendings'] = $this->category_model->get_channels($this->publisher['pid'], 'most_popular', 5);
  ...
  function channel_view($slug) {
    ...
    $this->view_data['categories'] = $this->category_model->get_categories($this->publisher['pid'], 0);
    $this->view_data['trendings'] = $this->category_model->get_channels($this->publisher['pid'], 'most_popular', 5);
    $this->view_data['stories'] = $this->story_model->get_published_channel_stories($this->publisher['pid'], 0, $channel['cid']);
    $this->load_view('common/stories', $this->view_data);
  }
  ...
  function hashtag_view($hash) {
    ...
    $this->view_data['categories'] = $this->category_model->get_categories($this->publisher['pid'], 0);
    $this->view_data['trendings'] = $this->category_model->get_channels($this->publisher['pid'], 'most_popular', 5);
    $this->view_data['stories'] = $this->story_model->get_stories_by_hashtag($this->publisher['pid'], 0, $hash);
    $this->load_view('common/stories', $this->view_data);
  }
