										...
										<div class="col-xl-8">
											<div class="k-section k-section--first">
												<div class="k-section__body">
													...
													<div class="form-group">
														<label class="col-8 col-form-label">Sub-domain</label>
														<div class="col-12">
															<div class="input-group">
																<input class="form-control" placeholder="Domain Name" name="domain" type="text" value="<?php echo $publisher['domain']; ?>">
