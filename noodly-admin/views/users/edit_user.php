                ...
                <form class="k-form" id="register-form"  method="post" enctype="multipart/form-data">
                  <input type="hidden" name="id" value="<?php echo $user_id; ?>" />
                          ...
                          <div class="form-group">
													...
													?>
													<div class="form-group">
														<label class="col-7 col-form-label">Super Admin?</label>
														<div class="col-12">
                          ...
                          <?php
                              ...
                              <select class="form-control" name="country" data-start-value="<?php echo count($user) ? $user['country'] : ''; ?>">
													...
													<div class="form-group">
														<label class="col-8 col-form-label">State / Province / Region</label>
														<div class="col-12">
													...
													<div class="form-group">
														<label class="col-7 col-form-label">City</label>
														<div class="col-12">
											...
											<div class="k-section">
												<div class="k-section__body">
													...
													<div class="form-group">
														<label class="col-8 col-form-label">Sound Cloud URL</label>
														<div class="col-12">
