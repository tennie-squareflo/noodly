              ...
              <tr>
                <td align="left" valign="top" style="padding: 0 10px;">
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                    <tbody>
                      <tr>
                        <td <?php echo $env['email_background_image'] !== '' ? "background='".ASSETS_URL.'media/email_background/'.$env['email_background_image']."'" : "" ?> bgcolor="<?php echo $env['email_background_color']; ?>" align="center" valign="top" style="background-position: top center; background-size: cover; border-radius: 8px; box-shadow: 0 2px 4px 0 rgba(0, 0, 0, 0.1)">
                          <!--[if gte mso 9]>
                              ...
                              <tr>
                                <td class="pc-sm-p-34-30-55 pc-xs-p-25-20-20" style="padding: 34px 40px 55px;" valign="top">
                                  ...
                                  <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                    <tbody>
                                      <tr>
                                        <td valign="top" align="center">
                                          <a href="//<?php echo $publisher['domain']; ?>" style="text-decoration: none;"><img src="<?php echo ASSETS_URL.'media/logos/'.$publisher['logo']; ?>" width="130" height="" alt="" style="max-width: 100%; height: auto; border: 0; line-height: 100%; outline: 0; -ms-interpolation-mode: bicubic; color: <?php echo $env['email_foreground_color'];?>;"></a>
                                        </td>
                                      </tr>
                                      <tr>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td class="pc-xs-lh-42 pc-xs-fs-30 pc-fb-font" style="text-align: center; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 36px; font-weight: 800; line-height: 46px; letter-spacing: -0.6px; color: <?php echo $env['email_foreground_color'];?>;" valign="top">Noodly Account Created&nbsp;</td>
                                      </tr>
                                      <tr>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td class="pc-fb-font" style="text-align: center; font-family: 'Fira Sans', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 300; line-height: 28px; letter-spacing: -0.2px; color: <?php echo $env['email_foreground_color'];?>;" valign="top">Hi <?php echo $user['firstname'];?>!<br>Please click on the button below to create a password for your new <strong>Noodly</strong> account.</td>
                                      </tr>
                                      <tr>
